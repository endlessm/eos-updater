 ...
 * between commtis. The checksum for the flatpak pulled into the
                                                            ...
                                                            gconstpointer      user_data)
{
  ...
  g_assert (g_strv_contains ((const gchar * const *) deployed_flatpaks, flatpaks_to_install[0].app_id));
  g_assert (!g_strv_contains ((const gchar * const *) deployed_flatpaks, flatpaks_to_install[1].app_id));
}
                                                                  ...
                                                                  gconstpointer      user_data)
{
  ...
  failed_flatpak_installation_directory = g_file_get_child (flatpak_user_installation_dir,
                                                            test_broken_flatpak_relative_path);
  eos_updater_remove_recursive (failed_flatpak_installation_directory, &error);
  g_assert_no_error (error);
                                       ...
                                       gconstpointer      user_data)
{
  ...
  g_assert (!g_strv_contains ((const gchar * const *) deployed_flatpaks,
                                   ...
                                   gconstpointer      user_data)
{
  ...
  g_assert (g_str_equal (installed_app_executable_contents, expected_app_executable_contents));
}
